...
[![Maven Central](https://img.shields.io/maven-central/v/com.openai/openai-java)](https://central.sonatype.com/artifact/com.openai/openai-java/2.13.0)
[![javadoc](https://javadoc.io/badge2/com.openai/openai-java/2.13.0/javadoc.svg)](https://javadoc.io/doc/com.openai/openai-java/2.13.0)
...
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.openai/openai-java/2.13.0).
...
```kotlin
implementation("com.openai:openai-java:2.13.0")
```
